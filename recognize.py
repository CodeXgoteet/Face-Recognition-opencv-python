...
face_detector = cv2.CascadeClassifier('lbph-face-recognition-master\lbph-face-recognition-master\classifiers\haarcascade_frontalface_alt.xml')
face_recognizer = cv2.face.LBPHFaceRecognizer_create(threshold=500)
face_recognizer.read('lbph-face-recognition-master\lbph-face-recognition-master\classifiers\lbphClassifier.yml')
