...
id_names = pd.read_csv('lbph-face-recognition-master\lbph-face-recognition-master\id-names.csv')
...
face_classifier = cv2.CascadeClassifier('lbph-face-recognition-master\lbph-face-recognition-master\classifiers\haarcascade_frontalface_alt.xml')
